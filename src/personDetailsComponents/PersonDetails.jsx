...
const PersonDetails = () => {
  ...
  return (
    <>
      <div
        style={{
          backgroundImage: info.details.profile_path
            ? `linear-gradient(90deg, rgba(0,0,0,.80) 0%, rgba(0,0,0,.80) 30%, rgba(0,0,0,.80) 60%, rgba(0,0,0,.80) 100%), url(https://image.tmdb.org/t/p/original${info.details.profile_path})`
