  ...
  return (
    <div className="mt-4 md:mt-7 mx-2 md:mx-10 flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-12">
      ...
      <div className="flex flex-col justify-between py-2 md:py-5 text-center md:text-left">
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold">{tv.name}</h1>

          {tv.tagline && (
            <p className="italic text-base md:text-lg text-zinc-400 mt-2 md:mt-3">{tv.tagline}</p>
          )}

          <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 sm:gap-3 mt-4 text-xs sm:text-sm">
            <span
              className="px-3.5 py-1.5 font-semibold rounded-full bg-zinc-900/60 backdrop-blur-md border-zinc-700 border flex items-center gap-2"
            >
            ...
            <span
              className="px-3.5 py-1.5 rounded-full bg-zinc-900/60 backdrop-blur-md border-zinc-700 border flex items-center gap-2"
            >
              <FaCalendar />
            ...
            <span
              className="px-3.5 py-1.5 rounded-full bg-[#C1121F] text-white flex items-center gap-2"
            >
              <FaFilm /> {tv.status}
            </span>
          </div>
